...
namespace SimpleBank.Infrastructure.Migrations
{
    ...
    [Migration("20230522104833_AddedAnAlternateCompositePrimaryKeyAndIndexForBankAccountEntity")]
    partial class AddedAnAlternateCompositePrimaryKeyAndIndexForBankAccountEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SimpleBank.Domain.Models.BankAccount", b =>
                {
                    ...
                    b.HasAlternateKey("AccountNumber", "BranchIFSC");

                    b.HasIndex("AccountNumber", "BranchIFSC");

                    b.ToTable("BankAccount", (string)null);
                });

            modelBuilder.Entity("SimpleBank.Domain.Models.BankBranch", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.OwnsOne("SimpleBank.Domain.Models.Address", "Address", b1 =>
                        {
                            ...
                            b1.HasKey("BankBranchId");

                            b1.ToTable("BankBranch");
